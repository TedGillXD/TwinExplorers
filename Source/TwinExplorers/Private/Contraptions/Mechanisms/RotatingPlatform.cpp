...
void ARotatingPlatform::Tick(float DeltaSeconds) {
	...
	FRotator CurrentRotation = PlatformMesh->GetComponentRotation();
	FRotator NewRotation = FRotator(CurrentRotation.Pitch, CurrentRotation.Yaw - DeltaRotation, CurrentRotation.Roll);
